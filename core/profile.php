...
$alert = $_GET['alert'];
?>
<input type="text" id="test1" class="alert" value="<?=  $alert ?>">
...
<!---Форма профиля-->
    ...
    <div class="tab">
    <a href="#" class="tab1 active">Активные заявки</a>
    <a href="profile2.php" class="tab1">Завершенные заявки</a>
    </div>
...
<footer class="footer">
  ...
  <script src="/core/js/alert.js"></script> 
